...
See [Datasets.md](Datasets.md) for full download instructions, licenses, and loading details.
...
- COCO val2017 -- manual download required (~1 GB); see [Datasets.md](Datasets.md)
...
1. You buy a copy of "Applications of Reading the Robot Mind" book for every member of your development team.
